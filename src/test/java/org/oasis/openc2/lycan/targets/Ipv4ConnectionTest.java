...
public class Ipv4ConnectionTest {
	...
	private String expected  = "{\"protocol\":\"tcp\",\"src_addr\":{\"cidr\":24,\"ipv4_addr\":\"1.2.3.4\"},\"src_port\":8443,\"dst_addr\":{\"cidr\":16,\"ipv4_addr\":\"2.3.4.5\"},\"dst_port\":9443}";
	private String inputJson = "{\"src_port\":8443,\"dst_port\":9443,\"src_addr\":{\"cidr\":24,\"ipv4_addr\":\"1.2.3.4\"},\"dst_addr\":{\"cidr\":16,\"ipv4_addr\":\"2.3.4.5\"},\"protocol\":\"tcp\"}";

	@Test
	public void test() throws Exception {
		Ipv4Connection connection = new Ipv4Connection();
		
		connection.setSrcAddr(new Ipv4Net().setIpv4Addr("1.2.3.4").setCidr(24));
		connection.setSrcPort(8443);
		connection.setDstAddr(new Ipv4Net().setIpv4Addr("2.3.4.5").setCidr(16));
